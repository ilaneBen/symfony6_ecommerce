 ...
 */
class getTexmexsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TexmexsRepository' shared autowired service.
     *
     * @return \App\Repository\TexmexsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TexmexsRepository.php';

        return $container->privates['App\\Repository\\TexmexsRepository'] = new \App\Repository\TexmexsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
