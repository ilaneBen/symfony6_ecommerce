 ...
 */
class getSandwichsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SandwichsRepository' shared autowired service.
     *
     * @return \App\Repository\SandwichsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SandwichsRepository.php';

        return $container->privates['App\\Repository\\SandwichsRepository'] = new \App\Repository\SandwichsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
