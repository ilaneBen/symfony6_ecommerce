 ...
 */
class getItemOrdersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ItemOrdersRepository' shared autowired service.
     *
     * @return \App\Repository\ItemOrdersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ItemOrdersRepository.php';

        return $container->privates['App\\Repository\\ItemOrdersRepository'] = new \App\Repository\ItemOrdersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
