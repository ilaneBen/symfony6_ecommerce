 ...
 */
class getBurgersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BurgersRepository' shared autowired service.
     *
     * @return \App\Repository\BurgersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BurgersRepository.php';

        return $container->privates['App\\Repository\\BurgersRepository'] = new \App\Repository\BurgersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
