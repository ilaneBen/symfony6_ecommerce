...
class __TwigTemplate_9c070cf96c4a4834077678ed80a090c1 extends Template
{
    private $source;
    private $macros = [];
...
<img src=\"";
 ...
 <div class= \"form-group\">
            ...
            ";
        // line 19
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["RequestMdpForm"]) || array_key_exists("RequestMdpForm", $context) ? $context["RequestMdpForm"] : (function () { throw new RuntimeError('Variable "RequestMdpForm" does not exist.', 19, $this->source); })()), 'form_start');
        echo "
            ";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["RequestMdpForm"]) || array_key_exists("RequestMdpForm", $context) ? $context["RequestMdpForm"] : (function () { throw new RuntimeError('Variable "RequestMdpForm" does not exist.', 20, $this->source); })()), "email", [], "any", false, false, false, 20), 'row');
        echo "
         <button type=\"submit\" class=\"btn btn-primary mt-2\">rennisialiser le mot de passe</button>

            ";
        // line 23
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["RequestMdpForm"]) || array_key_exists("RequestMdpForm", $context) ? $context["RequestMdpForm"] : (function () { throw new RuntimeError('Variable "RequestMdpForm" does not exist.', 23, $this->source); })()), 'form_end');
        echo "
        </div>
    </div>
    </div>
...
{% endblock %}
", "security/reset_mdp_request.html.twig", "C:\\Users\\i\\symfony_site\\templates\\security\\reset_mdp_request.html.twig");
    }
}
