...
class __TwigTemplate_24adff1fd410337f51ca8a5f07ef140c extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" placeholder='e-mail' id=\"inputEmail\" class=\"form-control\" autocomplete=\"email\" required autofocus>
    ...
    <button type=\"hidden\" name=\"_csrf_token\" class= 'btn btn-primary mt-2'
value=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken("authenticate"), "html", null, true);
        echo "\">S'identifier</button>
...
";
    ...
    {
        return array (  143 => 43,  135 => 28,  131 => 27,  124 => 23,  116 => 17,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    <h3>Identifiez-vous</h3>
    <label for=\"inputEmail\">E-mail</label>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" placeholder='e-mail' id=\"inputEmail\" class=\"form-control\" autocomplete=\"email\" required autofocus>
    <label for=\"inputPassword\">Mot de passe</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" placeholder='mot de passe' class=\"form-control\" autocomplete=\"current-password\" required>
    <button type=\"hidden\" name=\"_csrf_token\" class= 'btn btn-primary mt-2'
value=\"{{ csrf_token('authenticate') }}\">S'identifier</button>
    <a class= 'btn btn-primary mt-2' href=\"{{ path('app_register') }}\">S'enregistrer</a>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\i\\symfony_site\\templates\\security\\login.html.twig");
    }
}
