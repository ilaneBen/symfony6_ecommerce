...
class __TwigTemplate_62dc1d817301a163f0cae17fb77f1abc extends Template
{
    private $source;
    private $macros = [];
...
<p>Bonjour ";
        // line 2
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 2, $this->source); })()), "email", [], "any", false, false, false, 2), "html", null, true);
        echo ",</p>
<p>Votre inscription sur le site lagrilladerie est à valider en cliquant sur le lien ci-dessous :</p>
...
<p>Votre inscription sur le site lagrilladerie est à valider en cliquant sur le lien ci-dessous :</p>
<p><a class='btn btn-primary' href=\"{{ absolute_url(path('verify_user', {token: token})) }}\">{{ absolute_url(path('verify_user', {token: token})) }}</a></p>
<p>Ce lien expirera dans 3 heures</p>
", "emails/register.html.twig", "C:\\Users\\i\\symfony_site\\templates\\emails\\register.html.twig");
    }
}
