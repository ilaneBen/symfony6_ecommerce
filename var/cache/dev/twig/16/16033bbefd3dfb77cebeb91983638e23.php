...
class __TwigTemplate_be237183e800a511a69161f7f485e078 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<div class=\"card\" style=\"width: 18rem;\">
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class='btn btn-danger'>{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
</div>
", "user/_form.html.twig", "C:\\Users\\i\\symfony_site\\templates\\user\\_form.html.twig");
    }
}
