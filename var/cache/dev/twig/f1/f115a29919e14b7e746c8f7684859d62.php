...
/* user/new.html.twig */
class __TwigTemplate_156630b2e0464278311e58418ca523d4 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class='card'>S'enregistrer</h1>
...
{% block body %}
    <h1 class='card'>S'enregistrer</h1>

    <h4>{{ include('user/_form.html.twig') }}</h4>

    <a href=\"{{ path('app_user_index') }}\">back to list</a>
{% endblock %}
", "user/new.html.twig", "C:\\Users\\i\\symfony_site\\templates\\user\\new.html.twig");
    }
}
